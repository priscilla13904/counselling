                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Settings</p>
                            ...
                            <td width="15%">
                                ...
                                $doctorrow = $database->query("select  * from  counsellor;");
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/icons/counsellors-hover.svg');"></div>
                                        <div>
