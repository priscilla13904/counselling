        ...
        <?php
                ...
                $searchtype="All";
                        ...
                        if(!empty($_POST["search"])){
                            ...
                            $sqlmain= "select * from schedule inner join counsellor on schedule.docid=counsellor.docid where schedule.scheduledate>='$today' and (counsellor.docname='$keyword' or counsellor.docname like '$keyword%' or counsellor.docname like '%$keyword' or counsellor.docname like '%$keyword%' or schedule.title='$keyword' or schedule.title like '$keyword%' or schedule.title like '%$keyword' or schedule.title like '%$keyword%' or schedule.scheduledate like '$keyword%' or schedule.scheduledate like '%$keyword' or schedule.scheduledate like '%$keyword%' or schedule.scheduledate='$keyword' )  order by schedule.scheduledate asc";
                            //echo $sqlmain;
                            $insertkey=$keyword;
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Counsellor name or Email or Date (YYYY-MM-DD)" list="counsellors" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;
