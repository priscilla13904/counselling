            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-counsellor menu-active menu-icon-counsellor-active">
                        <a href="counsellors.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">All Counsellors</p></a></div>
                    </td>
                </tr>
                ...
                <tr class="menu-row" >
                 ...
                 <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="../alt_form/" class="non-style-link-menu"><div><p class="menu-text">Contact Counsellor</p></a></div>
                    </td>
                </tr>
