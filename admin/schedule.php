            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                    ...
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <select name="docid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            ...
                            <?php 
                                ...
                                $list11 = $database->query("select  * from  counsellor order by docname asc;");
                ...
                <?php
                    if($_POST){
                        ...
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.scheduleid,schedule.title,counsellor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join counsellor on schedule.docid=counsellor.docid ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,counsellor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join counsellor on schedule.docid=counsellor.docid  order by schedule.scheduledate desc";
